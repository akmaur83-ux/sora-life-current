...
let failed = 0;
for (const name of ['portal-dashboard', 'portal-dashboard-reference', 'portal-earnings', 'portal-links', 'portal-links-reference', 'portal-campaigns', 'portal-campaigns-reference', 'portal-analytics', 'portal-analytics-reference', 'portal-analytics-empty', 'portal-tier', 'portal-profile', 'portal-profile-reference', 'portal-dashboard-empty', 'portal-earnings-empty', 'home-leaderboard']) {
